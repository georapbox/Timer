...
var hljs = (function () {
  ...
  var ne = (e => {
    ...
    function f(e, t, i, r) {
      ...
      function b(e, n) {
        return (
          ...
          e.beginScope &&
            (e.beginScope._wrap
              ? (k.addKeyword(S, N.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
                (S = ''))
        ...
        if (((h = r), 'begin' === r.type))
          return (e => {
            ...
            return (
              t.skip
                ? (S += n)
                : (t.excludeBegin && (S += n), g(), t.returnBegin || t.excludeBegin || (S = n)),
              b(t, e),
    ...
    function y(e) {
      ...
      const t = (e => {
        ...
        if (t) {
          ...
          return (
            n ||
              (q(o.replace('{}', t[1])), q('Falling back to no-highlight mode for this block.', e)),
            n ? t[1] : 'no-highlight'
          );
        }
    ...
    'undefined' != typeof window &&
      ...
      Object.assign(e, {
        ...
        registerLanguage: (t, a) => {
          ...
          try {
            ...
            if ((K("Language definition for '{}' could not be registered.".replace('{}', t)), !s))
              throw e;
            K(e), (i = l);
          }
          i.name || (i.name = t),
      ...
      (e.regex = { concat: m, lookahead: g, either: p, optional: b, anyNumberOfTimes: u });
  ...
  var Ue = Object.freeze({
    ...
    grmr_kotlin: e => {
      ...
      const s = {
        ...
        o = {
          className: 'meta',
          begin: '@' + e.UNDERSCORE_IDENT_RE,
          contains: [{ begin: /\(/, end: /\)/, contains: [e.inherit(r, { className: 'string' })] }]
        },
        l = ge,
    ...
    grmr_php: e => {
      const n = e.regex,
        ...
        _ = {
          ...
          match: [
            /\b/,
            n.concat('(?!fn\\b|function\\b|', m(g).join('\\b|'), '|', m(u).join('\\b|'), '\\b)'),
            a,
            n.concat(l, '*'),
            n.lookahead(/(?=\()/)
          ],
    ...
    grmr_ruby: e => {
      const n = e.regex,
        ...
        g = { className: 'params', begin: '\\(', end: '\\)', endsParent: !0, keywords: a },
        u = [
          l,
          {
            className: 'class',
    ...
    grmr_swift: e => {
      const n = { match: /\s+/, relevance: 0 },
        ...
        N = (e = '') => ({ begin: m(e, /"""/), end: m(/"""/, e), contains: [f(e), E(e), y(e)] }),
        w = (e = '') => ({ begin: m(e, /"/), end: m(/"/, e), contains: [f(e), y(e)] }),
        v = {
          className: 'string',
        ...
        M = [
          {
            match: /(@|#(un)?)available/,
            className: 'keyword',
            starts: { contains: [{ begin: /\(/, end: /\)/, keywords: ze, contains: [...b, h, v] }] }
          },
    ...
    grmr_typescript: e => {
      const n = Ne(e),
        t = ['any', 'void', 'number', 'boolean', 'string', 'object', 'never', 'enum'],
        a = {
          beginKeywords: 'namespace',
          end: /\{/,
          excludeEnd: !0,
